...
class PlayerCMD(commands.Cog):
    ...
    async def give_money(self, inter, card_id: str, sum: int):
        ...
        # Получаем инфу о карте по айди пользователя и карты
        ...
        # Получаем баланс и расчитываем новый
        ...
        responce_chnl_system = discord.Embed(
        ...
        responce_chnl_system.set_footer(
        ...
        responce_reciever_pm.set_footer(
            text=f'{main.copyright()}',
            icon_url=f'https://cdn.discordapp.com/attachments/1053188377651970098/1238899111948976189/9.png?ex=6640f635&is=663fa4b5&hm=541eea40573fd92a3861ed259706dff887d9934650b5aab7f698c0e9842cf9bd&'
        )
